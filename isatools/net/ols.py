...
def get_ols_ontologies():
    ...
    ontologiesUri = OLS_API_BASE_URI + '/ontologies?size=' + \
                    str(OLS_PAGINATION_SIZE)
...
def search_ols(term, ontology_source):
    ...
    queryObj = {
        ...
        'start': 0,
        'ontology': ontology_source.name if isinstance(
            ontology_source, OntologySource) else ontology_source
    }
